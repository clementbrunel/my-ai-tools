...
| Tool                                  | Description                                                                                                                |
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------|
| [`ai-env-manager`](./ai-env-manager/) | Scans and diagnoses your Claude Code / AI environment, checks for tool updates, manages a catalogue of recommended tools with guided or automated installation, and migrates the environment to a Mistral configuration |
