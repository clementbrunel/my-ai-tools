...
|-------------------|------------------|-----------------------------------------------------------------|
| `ai-env-manager/` | `ai-env-manager` | Scans, diagnoses, and manages a Claude Code project's AI setup (MCP servers, context, hooks, tool updates, install catalogue, post-install verification) |
